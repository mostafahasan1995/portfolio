      ...
      >
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="text-center lg:text-left">
            ...
            <motion.h1
              variants={item}
              className="gradient-text mb-4 break-words text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl"
            >
              {personal.name}
            </motion.h1>
            ...
            <motion.h2
              variants={item}
              className="mb-4 flex flex-wrap items-center justify-center gap-x-3 text-xl font-semibold text-gray-800 dark:text-gray-100 sm:text-2xl md:text-3xl lg:justify-start"
            >
            ...
            <motion.div
              variants={item}
              className="mb-6 flex items-center justify-center space-x-2 text-gray-700 dark:text-gray-300 lg:justify-start"
            >
            ...
            <motion.p
              variants={item}
              className="mx-auto mb-8 max-w-xl text-base text-gray-600 dark:text-gray-400 sm:text-lg lg:mx-0"
            >
          ...
          {/* Right — animated tech orbit (large screens only) */}
          <motion.div
            variants={item}
        ...
        {/* Tech stack marquee — full width under the columns */}
