...
export const experiences: Experience[] = [
  {
    ...
    achievements: [
      ...
      "Contributed to frontend development of Imkan platform (imkan.larsa.io) in production",
  ...
  },
  {
    ...
    description: "Developed full-stack web applications with focus on frontend development",
    achievements: [
      "Developed responsive and interactive frontend applications using React.js and modern JavaScript",
      "Built RESTful APIs using Node.js and Express for backend services",
      "Implemented user-friendly interfaces with modern UI/UX best practices",
  ...
  },
  {
    ...
    description: "Built full-stack e-commerce platform from concept to production deployment",
    achievements: [
      "Built full-stack e-commerce marketplace platform (abraa.com) from concept to production",
      "Developed responsive frontend interfaces with modern JavaScript frameworks",
      "Designed database schemas and optimized queries for high-performance operations",
      "Integrated third-party APIs, payment gateways, and secure transaction systems",
      "Implemented multi-language support and internationalization features",
    ],
  },
];
